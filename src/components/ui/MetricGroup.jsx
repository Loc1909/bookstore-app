    ...
    return (
        <>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                {/* Metric Item Start */}
                <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-300 dark:bg-white/3 md:p-6">
                    ...
                    <div className="mt-5 flex items-end justify-between">
                        <div>
                            <span className="text-2xl font-bold text-gray-500 dark:text-gray-400">Customers</span>
                            <h4 className="mt-2 text-title-sm font-bold text-gray-800 dark:text-red-600">
                                3,782
                            </h4>
                        </div>
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-300 dark:bg-white/3 md:p-6">
                    ...
                    <div className="mt-5 flex items-end justify-between">
                        <div>
                            <span className="text-2xl font-bold text-gray-500 dark:text-gray-400">Orders</span>
                            <h4 className="mt-2 text-title-sm font-bold text-gray-800 dark:text-red-600">
                                5,359
                            </h4>
                        </div>
